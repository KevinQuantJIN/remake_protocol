    ...
    <div>
      ...
      <div className="navbar flex h-20 flex-row md:mb-2 shadow-lg bg-black text-neutral-content border-b border-zinc-600 bg-opacity-66">
        <div className="navbar-start align-items-center">
          <div className="hidden sm:inline w-80 h-35 md:p-2 ml-10 mt-4">
            
            <Link href="/" passHref>
              <img src="/image.png" alt="My Logo" className="w-full h-auto" />
            </Link>
          </div>
        ...
        <div className="navbar-end">
          ...
          <label
              ...
              <div className={`h-0.5 w-8 bg-[#bbed42] ${isNavOpen ? 'hidden' : ''}`} />
              <div className={`h-0.5 w-8 bg-[#bbed42] ${isNavOpen ? 'hidden' : ''}`} />
              <div className={`h-0.5 w-8 bg-[#bbed42] ${isNavOpen ? 'hidden' : ''}`} />
            </div>
            <div className={`absolute block h-0.5 w-8 animate-pulse bg-[#bbed42] ${isNavOpen ? "" : "hidden"}`}
